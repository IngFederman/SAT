...
void sendmail::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->resultadoMail((*reinterpret_cast< QString(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (sendmail::*_t)(QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&sendmail::resultadoMail)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject sendmail::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_sendmail.data,
...
// SIGNAL 0
void sendmail::resultadoMail(QString _t1)
{
